...
var messages = [...]*i18n.Message{
	...
	{ID: "task_results", Other: "results"},
	{ID: "task_save", Other: "save"},
	{ID: "task_saving", Other: "saving"},
	{ID: "task_sort", Other: "sort"},
...
func init() {
	...
	_, err := bundle.LoadMessageFileFS(localeFS, "active.de.toml")
	if err != nil {
...
func (m *translator) Translate(messageID string) string {
	...
	translation, err := m.localizer.Localize(&i18n.LocalizeConfig{DefaultMessage: message})
	if err != nil {
...
func (m *translator) TranslateData(messageID string, data map[string]string) string {
	...
	translation, err := m.localizer.Localize(&i18n.LocalizeConfig{DefaultMessage: message, TemplateData: data})
	if err != nil {
		log.Warn(fmt.Sprintf("translation error: %v", err), "messageID", messageID)
